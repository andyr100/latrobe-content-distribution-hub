  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        {open && <div id="channel-options" role="listbox" aria-multiselectable="true" className="absolute z-20 mt-2 max-h-56 w-full overflow-y-auto rounded-xl border border-[var(--border-strong)] bg-[var(--surface-strong)] p-1.5 shadow-[var(--shadow)] backdrop-blur-xl">
