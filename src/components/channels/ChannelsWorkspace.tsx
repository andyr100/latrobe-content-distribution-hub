...
export function ChannelsWorkspace() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mb-5 flex items-center justify-between"><p className="muted text-sm">{channels.length} subject channels</p><p className="muted text-xs">{channels.filter((channel) => channel.active).length} active</p></div>
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {channels.map((channel) => <GlassCard key={channel.id} className="group flex min-h-64 flex-col p-5">
